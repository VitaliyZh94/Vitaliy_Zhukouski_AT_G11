...
//        storableProcessor.runStorable(containerBottle, pourableDiesel);  need Storable
//        storableProcessor.runStorable(matterBottle, powerableDiesel);  need Storable, Pourable
//        storableProcessor.runStorable(can, matterPetrol);  need Pourable
        storableProcessor.runStorable(storableCan, water);
//        storableProcessor.runStorable(containerCan, pourableWater);  need Storable
//        storableProcessor.runStorable(matterCan); need Storable, Pourable
    }
}
